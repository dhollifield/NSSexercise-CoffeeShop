...
// const addNewBeanVariety = async (newBeanVariety) => {
//     const fetchOptions = {
//         method: "POST",
//         headers: {
//             "Content-Type": "application/json"
...
//     const formContainer = document.getElementById("addBeanForm")
//     const resp = await fetch(url, fetchOptions)
//     const responseJson = await resp.json(resp)
//     formContainer.dispatchEvent(new CustomEvent("stateChanged"))
//     return responseJson
// }
